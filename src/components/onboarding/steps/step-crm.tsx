    ...
    <div className="flex flex-col gap-7">
      <div className="grid gap-3 md:grid-cols-2">
        {HIGHLIGHTS.map((h) => (
          ...
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#ffd24a] to-[#ff8a5b] text-[color:var(--color-ink-900)] shadow-[0_6px_14px_-6px_rgba(255,138,91,0.4)]">
