...
export function StepHeader({ num, title, description, className }: StepHeaderProps) {
  return (
    <div className={cn("flex items-start gap-5", className)}>
      <span className="relative flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-[#a855f7] via-[#8b5cf6] to-[#7c3aed] text-xl font-black text-white shadow-[0_14px_36px_-12px_rgba(13,148,136,0.55)]">
        <span
          aria-hidden
