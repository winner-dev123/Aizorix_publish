...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11px] font-semibold tracking-tight whitespace-nowrap [&_svg]:size-3 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        violet:
          "bg-gradient-to-br from-[#ede9fe] to-[#ddd6fe] text-[#5b21b6] border border-[#c4b5fd]/60",
        cyan:
          "bg-gradient-to-br from-cyan-50 to-cyan-100 text-cyan-800 border border-cyan-200/70",
        accent:
          "bg-[color:var(--color-ink-900)] text-[color:var(--color-brand-300)] border border-[color:var(--color-ink-800)]",
        ...
        "glass-violet":
          "bg-[#7c3aed]/15 text-white border border-[#a78bfa]/30 backdrop-blur-md",
      },
      uppercase: {
        true: "uppercase",
        false: "normal-case",
