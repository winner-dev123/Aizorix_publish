...
export function AdminSignInForm() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="space-y-4 rounded-3xl border border-[color:var(--color-ink-100)] bg-[color:var(--color-surface-1)] p-7 shadow-[var(--shadow-lg)] dark:border-white/10"
    >
      <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-[color:var(--color-brand-600)] dark:text-[color:var(--color-brand-300)]">
        <ShieldCheck className="h-3.5 w-3.5" />
        Platform admin
      </div>
      <h1 className="text-2xl font-black tracking-tight text-[color:var(--color-ink-900)]">
        Inicia sesión
      </h1>
