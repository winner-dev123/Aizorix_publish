                  ...
                  return (
                    ...
                    >
                      {slots.map((a) => (
                        <div
                          key={a.id}
                          className="rounded-lg bg-gradient-to-br from-[#a855f7] via-[#8b5cf6] to-[#7c3aed] px-2 py-1.5 text-[10px] font-semibold text-white shadow-[0_6px_14px_-6px_rgba(13,148,136,0.45)]"
                        >
